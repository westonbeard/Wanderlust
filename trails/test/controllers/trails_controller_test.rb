...
class TrailsControllerTest < ActionController::TestCase
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post :create, trail: { comments: @trail.comments, geocode: @trail.geocode, name: @trail.name, url: @trail.url }
    end
  ...
  test "should update trail" do
    patch :update, id: @trail, trail: { comments: @trail.comments, geocode: @trail.geocode, name: @trail.name, url: @trail.url }
    assert_redirected_to trail_path(assigns(:trail))
  end
